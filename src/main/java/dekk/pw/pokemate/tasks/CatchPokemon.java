                    ...
                    if (encounterResult.wasSuccessful()) {
                        ...
                        if (catchResult.getStatus().equals(CatchPokemonResponseOuterClass.CatchPokemonResponse.CatchStatus.CATCH_SUCCESS)) {
                            try {
                                ...
                                String output = "Caught a " + getIvRatio(p) + "% " +  StringConverter.convertPokename(target.getPokemonId()) + " [" +p.getIndividualAttack() + "/" + p.getIndividualDefense() + "/" + p.getIndividualStamina() + "] at " + p.getCp() + " CP using a " + StringConverter.convertItem(ball.getItemId().name()) + " (Candy: " + p.getCandy() + ")";
